...
namespace VATRP.Linphone.VideoWrapper
{
    ...
    public class OutlinedTextControl : FrameworkElement
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            if (text != null)
            {
                text.MaxTextWidth = Math.Min(3579139, availableSize.Width);
                text.MaxTextHeight = Math.Max(0.0001d, availableSize.Height);
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            // re-generate the geometry now that the dimensions have changed
        ...
        {
            var outlinedTextBlock = (OutlinedTextControl)dependencyObject;
